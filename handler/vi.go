...
func (vi *Vi) handleNormal(ev *termbox.Event) error {
	switch ev.Type {
...
func (vi *Vi) handleInsert(ev *termbox.Event) error {
	return nil
}

func (vi *Vi) handleVisual(ev *termbox.Event) error {
	return nil
}

func (vi *Vi) handleVisualLine(ev *termbox.Event) error {
	return nil
}

func (vi *Vi) handleVisualBlock(ev *termbox.Event) error {
	return nil
}
...
func (vi *Vi) Handle(ev *termbox.Event) error {
	switch vi.mode {
	case Normal:
