...
echo2 "  - linux/riscv"
docker build -t ernestrc-pty-test -f Dockerfile.riscv .
...
echo2 "  - darwin/386"
docker build -t ernestrc-pty-test -f Dockerfile.golang --build-arg=GOVERSION=1.14 --build-arg=GOOS=darwin --build-arg=GOARCH=386 .
echo2 "  - darwin/arm"
docker build -t ernestrc-pty-test -f Dockerfile.golang --build-arg=GOVERSION=1.14 --build-arg=GOOS=darwin --build-arg=GOARCH=arm .
...
echo2 "  - linux/amd64"
docker build -t ernestrc-pty-test -f Dockerfile.golang --build-arg=GOVERSION=1.6 --build-arg=GOOS=linux --build-arg=GOARCH=amd64 .
