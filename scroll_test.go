...
func TestScrollDraw(t *testing.T) {
	...
	tests := []testCase{
		{nil, "Love in \nLove isn"},
		{func() { window.SeekUp() }, "Love in \nLove isn"},
		{func() { window.SeekLeft() }, "Love in \nLove isn"},
		{func() { window.SeekRight() }, "ove in y\nove isn'"},
		{func() { window.SeekLeft() }, "Love in \nLove isn"},
		{func() { window.SeekDown() }, "Love isn\n        "},
		{func() { window.SeekDown() }, "Love isn\n        "},
		{func() { window.SeekRight() }, "ove isn'\n       -"},
		{func() { window.SeekStartFile() }, "ove in y\nove isn'"},
		{func() { window.SeekEndFile() }, "ove isn'\n       -"},
		{func() { window.SeekStartLine() }, "Love isn\n        "},
		{func() { window.SeekStartFile() }, "Love in \nLove isn"},
		{func() { window.Move(1, 1) }, "        \n Love in"},
		{func() { window.Move(0, 0) }, "Love in \nLove isn"},
		{func() { window.Search("Love") }, "Love in \nLove isn"},
		{func() { window.SeekNextResult() }, "Love in \nLove isn"},
		{func() { window.Resize(20, 1); w = NewStringWriter(20, 1) }, "Love in your heart w"},
		{func() { window.Search("you") }, "Love in your heart w"},
		{func() { window.SeekNextResult() }, "Love in your heart w"},
		{func() { window.SeekNextResult() }, " isn't love 'til you"},
		{func() { window.SeekPrevResult() }, " in your heart wasn'"},
		...
		{func() { window.SeekDown() }, "Love isn't love 'til"},
...
func TestScrollDrawWrap(t *testing.T) {
	...
	tests := []testCase{
		...
		{func() { window.SeekUp() }, "Love in \nyour hea"},
		{func() { window.SeekLeft() }, "Love in \nyour hea"},
		{func() { window.SeekRight() }, "Love in \nyour hea"},
		{func() { window.SeekLeft() }, "Love in \nyour hea"},
		{func() { window.SeekDown() }, "Love isn\n't love "},
		{func() { window.SeekDown() }, "Love isn\n't love "},
		{func() { window.SeekRight() }, "Love isn\n't love "},
		{func() { window.SeekStartFile() }, "Love in \nyour hea"},
		{func() { window.SeekEndFile() }, "Love isn\n't love "},
		{func() { window.SeekStartLine() }, "Love isn\n't love "},
		{func() { window.SeekStartFile() }, "Love in \nyour hea"},
		{func() { window.Move(1, 1) }, "        \n Love in"},
		{func() { window.Move(0, 0) }, "Love in \nyour hea"},
