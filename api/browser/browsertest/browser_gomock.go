...
//
//	mockgen -destination=./browsertest/browser_gomock.go -package browsertest -self_package unstable.build/go-tui/api/browser/browsertest -source ./browser.go
//
...
func (m *MockWindowManager) Floating(h api.Floating, cfg component.FloatingConfig) (api.Window, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Floating", h, cfg)
	ret0, _ := ret[0].(api.Window)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Focus mocks base method.
func (m *MockWindowManager) Focus() (api.Window, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Focus")
	ret0, _ := ret[0].(api.Window)
	ret1, _ := ret[1].(error)
...
func (m *MockWindowManager) SetFocus(win api.Window) (api.Window, error) {
	m.ctrl.T.Helper()
...
func (m *MockWindowManager) Split(arg0 api.Orientation, arg1 api.Window, arg2 api.Handler) (api.Window, error) {
	m.ctrl.T.Helper()
...
func (mr *MockEventPublisherMockRecorder) Interrupt(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Floating mocks base method.
func (m *MockBrowser) Floating(h api.Floating, cfg component.FloatingConfig) (api.Window, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Floating", h, cfg)
	ret0, _ := ret[0].(api.Window)
	ret1, _ := ret[1].(error)
...
// Focus mocks base method.
func (m *MockBrowser) Focus() (api.Window, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Focus")
	ret0, _ := ret[0].(api.Window)
	ret1, _ := ret[1].(error)
...
// Interrupt indicates an expected call of Interrupt.
func (mr *MockBrowserMockRecorder) Interrupt(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// SetFocus mocks base method.
func (m *MockBrowser) SetFocus(win api.Window) (api.Window, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SetFocus", win)
	ret0, _ := ret[0].(api.Window)
	ret1, _ := ret[1].(error)
...
// Split mocks base method.
func (m *MockBrowser) Split(arg0 api.Orientation, arg1 api.Window, arg2 api.Handler) (api.Window, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Split", arg0, arg1, arg2)
	ret0, _ := ret[0].(api.Window)
	ret1, _ := ret[1].(error)
