...
func TestIntegrationRace(t *testing.T) {
	...
	resources := extension.WorkspaceResources(workspace)
	...
	perms := map[extension.Permission]extension.Grant{
		extension.PermissionFileSystem: {Token: grantID, Context: ctx},
		extension.PermissionTerminal:   {Token: grantID, Context: ctx},
		extension.PermissionExecute:    {Token: grantID, Context: ctx},
	}
