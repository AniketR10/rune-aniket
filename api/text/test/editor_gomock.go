...
// Edit mocks base method.
func (m *MockEditor) Edit(file workspaceapi.URI, buf *cell.Buffer) (api.Handler, error) {
	m.ctrl.T.Helper()
...
func (m *MockEditor) Editor(file workspaceapi.URI) (api.Handler, error) {
	m.ctrl.T.Helper()
...
func (m *MockEditor) SubscribeCommand(arg0 string, arg1 api.CommandHandler) error {
	m.ctrl.T.Helper()
...
func (m *MockEditor) SubscribeEditorEvents(arg0 []api.EventType, arg1 api.EventHandler) error {
	m.ctrl.T.Helper()
