...
//
//	mockgen -destination=./browsertest/browser_gomock.go -package browsertest -self_package unstable.build/go-tui/api/browserapi/browsertest -source ./browser.go
//
...
func (m *MockWindowManager) Split(arg0 browserapi.Orientation, arg1 browserapi.Window, arg2 browserapi.Handler) (browserapi.Window, error) {
	m.ctrl.T.Helper()
...
// Focus mocks base method.
func (m *MockBrowser) Focus() (browserapi.Window, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Focus")
	ret0, _ := ret[0].(browserapi.Window)
	ret1, _ := ret[1].(error)
...
// Split mocks base method.
func (m *MockBrowser) Split(arg0 browserapi.Orientation, arg1 browserapi.Window, arg2 browserapi.Handler) (browserapi.Window, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Split", arg0, arg1, arg2)
	ret0, _ := ret[0].(browserapi.Window)
	ret1, _ := ret[1].(error)
