...
var (
	...
	proc_fill_console_output_character    = kernel32.NewProc("TestComponentConsoleOutputCharacterW")
	proc_fill_console_output_attribute    = kernel32.NewProc("TestComponentConsoleOutputAttribute")
