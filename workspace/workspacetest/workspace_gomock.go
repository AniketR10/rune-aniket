...
//
//	mockgen -destination=./workspacetest/workspace_gomock.go -package workspacetest -self_package unstable.build/go-tui/workspace/workspacetest -source ./workspace.go
//
