...
// All implementations must embed UnimplementedKeyMapperServer
// for forward compatibility
type KeyMapperServer interface {
	MergeKeyMap(context.Context, *MergeKeyMapRequest) (*MergeKeyMapResponse, error)
	mustEmbedUnimplementedKeyMapperServer()
}

// UnimplementedKeyMapperServer must be embedded to have forward compatible implementations.
...
func (UnimplementedKeyMapperServer) mustEmbedUnimplementedKeyMapperServer() {}

// UnsafeKeyMapperServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to KeyMapperServer will
// result in compilation errors.
type UnsafeKeyMapperServer interface {
	mustEmbedUnimplementedKeyMapperServer()
}

func RegisterKeyMapperServer(s grpc.ServiceRegistrar, srv KeyMapperServer) {
	s.RegisterService(&KeyMapper_ServiceDesc, srv)
}
...
// KeyMapper_ServiceDesc is the grpc.ServiceDesc for KeyMapper service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var KeyMapper_ServiceDesc = grpc.ServiceDesc{
