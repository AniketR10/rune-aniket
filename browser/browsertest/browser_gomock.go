...
//
//	mockgen -destination=./browsertest/browser_gomock.go -package browsertest -self_package unstable.build/rune/browser/browserrpctest -source ./browser.go
//
...
import (
	...
	browser "unstable.build/rune/browser"
)
