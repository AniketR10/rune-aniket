...
//
//	mockgen -destination=text/texttest/editor_gomock.go -package texttest -self_package unstable.build/rune/text/texttest -source text/editor.go
//
