...
import (
	...
	issuesPlugin "unstable.build/go-tui/cmd/plugin_issues/plugin"
...
func Grantee(versionTag string) (plugin.Grantee, []plugin.Permission) {
	return issuesPlugin.GranteeWithService(versionTag, defaultIssuesScheme, func(pconfig config.Config) (document.Service, error) {
