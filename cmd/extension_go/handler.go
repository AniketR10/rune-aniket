...
func newGoHandler(
	...
	handlers := map[string]textapi.CommandHandler{
		...
		"extract-method": codeActionHandler(lsp, editor, notify, wm, sel, "refactor.extract.method",
			"Select statements inside a method to extract"),
		"extract-variable-all": codeActionHandler(lsp, editor, notify, wm, sel, "refactor.extract.variable-all",
			"Select an expression to extract all occurrences as a variable"),
		"extract-constant": codeActionHandler(lsp, editor, notify, wm, sel, "refactor.extract.constant",
			"Select a constant expression to extract"),
		"extract-constant-all": codeActionHandler(lsp, editor, notify, wm, sel, "refactor.extract.constant-all",
			"Select a constant expression to extract all occurrences"),
		"extract-to-new-file": codeActionHandler(lsp, editor, notify, wm, sel, "refactor.extract.toNewFile",
		...
		"inline-variable": codeActionHandler(lsp, editor, notify, wm, sel, "refactor.inline.variable",
		...
		"remove-unused-param": codeActionHandler(lsp, editor, notify, wm, sel, "refactor.rewrite.removeUnusedParam",
			"Place cursor on an unused function parameter to remove it"),
		"move-param-left": codeActionHandler(lsp, editor, notify, wm, sel, "refactor.rewrite.moveParamLeft",
			"Place cursor on a function parameter to move it left"),
		"move-param-right": codeActionHandler(lsp, editor, notify, wm, sel, "refactor.rewrite.moveParamRight",
			"Place cursor on a function parameter to move it right"),
		"change-quote": codeActionHandler(lsp, editor, notify, wm, sel, "refactor.rewrite.changeQuote",
			"Place cursor on a string literal to toggle between raw and interpreted form"),
		"split-lines": codeActionHandler(lsp, editor, notify, wm, sel, "refactor.rewrite.splitLines",
			"Place cursor inside a bracketed list to split items onto separate lines"),
		"join-lines": codeActionHandler(lsp, editor, notify, wm, sel, "refactor.rewrite.joinLines",
			"Place cursor inside a multi-line bracketed list to join items onto one line"),
		"eliminate-dot-import": codeActionHandler(lsp, editor, notify, wm, sel, "refactor.rewrite.eliminateDotImport",
