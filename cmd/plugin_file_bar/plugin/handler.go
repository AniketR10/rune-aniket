...
// Grantee returns this plugin's Grantee.
func Grantee() (plugin.Grantee, []plugin.Permission) {
	return plugutil.NewEditorEventHandler(FileBarHandlerCommands,
		newFileBarEditorHandler, FileBarHandlerEvents,
		FileBarHandlerPermissions...)
}

var (
	// FileBarHandlerCommands returns the commands that this plugin is
	// interested in registering.
	FileBarHandlerCommands = []string{}

	// FileBarHandlerEvents returns the events that this plugin is
