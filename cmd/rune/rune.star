...
GUI_THEMES = {
    "furman": {
        ...
        "silver": "#b4b4b4", "gray": "#3d3f41", "red": "#B95A53",
    ...
    "romero": {
        ...
        "silver": "#bbc2cf", "gray": "#282c34", "red": "#990000",
    ...
    "carmack": {
        ...
        "silver": "#d0b7ab", "gray": "#231B0E", "red": "saddlebrown",
    ...
    "reynolds": {
        ...
        "silver": "#bbc2cf", "gray": "#282c34", "red": "saddlebrown",
    ...
    "brevik": {
        ...
        "silver": "#bbc2cf", "gray": "#282c34", "red": "#cd2e20",
    ...
    "thompson": {
        ...
        "teal": "#6ab0a3", "silver": "#ffffff", "gray": "#3f4d64",
    ...
    "pike": {
        ...
        "silver": "#000000", "gray": "#6e6e9e", "red": "#ca7c5e",
    ...
    "auge": {
        ...
        "silver": "#d9d9d9", "gray": "#663300", "red": "#ff3300",
    ...
    "ritchie": {
        ...
        "silver": "#e5e9f0", "gray": "#565656", "red": "#ec5357",
    ...
    "kelleher": {
        ...
        "silver": "#c4c5b5", "gray": "#625e4c", "red": "#f4005f",
    ...
    "greig": {
        ...
        "silver": "#ffffff", "gray": "#614d85", "red": "#fe4450",
...
config = {
    ...
    "editor": {
        ...
        "status_bar": {
            ...
            # reverse, and dim.
            "layout": ' {{ .Status | bg "red" | fg "white" | bold }} █▓▒░  {{ .Filepath | fg "silver" }}  {{ .GitShortRef | fg "silver" }}   {{ .GitDiffAdd | fg "green" }}   {{ .GitDiffDel | fg "red" }} {{ .ShiftRight }} {{ .CursorColumn | fg "silver" }}:{{ .CursorLine | fg "silver" }}  {{ .TotalLines | fg "silver" }} lines  ░▒▓█ {{ .Language | bold | fg "silver" | bg "red"}} ',
    ...
    "command": {
        ...
        "key_bindings": {
            ...
            "<a-e>":          "lsp references",
            "<a-s-e>":        "echo {prompt}lsp<space>references<space>",
            "<a-g>":          "lsp definition",
            "<a-s-g>":        "echo {prompt}lsp<space>definition<space>",
