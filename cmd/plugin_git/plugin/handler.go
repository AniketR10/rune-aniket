...
func Grantee() (plugin.Grantee, []plugin.Permission) {
	return plugutil.NewEditorEventHandler(GitHandlerCommands, newGitHandler,
		GitHandlerEvents, GitHandlerPermissions...)
}

var (
	// GitHandlerCommands returns the commands that this plugin is
	// interested in registering.
	GitHandlerCommands = []string{commandNextChange, commandPrevChange}
	// GitHandlerEvents returns the events that this plugin is
