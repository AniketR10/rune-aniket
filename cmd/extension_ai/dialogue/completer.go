...
type Completer interface {
	...
	// complete Metadata field returned by llm.Service at the end
	// of the stream and also allows them to handle llm.FinishReason.
...
type FuncCompleter func(context.Context, string, string,
	llm.FinishReason, llm.ChatCompletionMessage)
