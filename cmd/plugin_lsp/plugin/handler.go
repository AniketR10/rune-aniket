...
func Grantee() (plugin.Grantee, []plugin.Permission) {
	return plugutil.NewEditorEventHandler(
		LSPHandlerCommands, newLspHandler,
		LSPHandlerEvents, LSPHandlerPermissions...)
}

var (
	// LSPHandlerCommands returns the commands that this plugin is
	...
	// LSPHandlerEvents returns the events that this plugin is
