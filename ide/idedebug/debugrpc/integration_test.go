...
func TestClient_SessionManagement(t *testing.T) {
	tests := []struct {
		name   string
		action func(*debugrpc.Client, context.Context) error
		verify func(*mockDebugger) bool
	}{
		{
			name:   "ConfigurationDone",
			action: func(c *debugrpc.Client, ctx context.Context) error { return c.ConfigurationDone(ctx) },
			verify: func(m *mockDebugger) bool { return m.configurationDoneCalled },
		},
		{
			name: "Disconnect",
			action: func(c *debugrpc.Client, ctx context.Context) error {
		...
		{
			name:   "Restart",
			action: func(c *debugrpc.Client, ctx context.Context) error { return c.Restart(ctx) },
...
func TestClient_Breakpoints(t *testing.T) {
	tests := []struct {
		...
		action    func(*debugrpc.Client, context.Context) (interface{}, error)
		wantLen   int
	}{
		{
			name: "SetBreakpoints",
			...
			action: func(c *debugrpc.Client, ctx context.Context) (interface{}, error) {
...
func newTestEnv(t *testing.T) *testEnv {
	...
	client := debugrpc.NewClient(context.Background(), conn)
