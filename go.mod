...
require (
	...
	github.com/unstablebuild/rune-go-sdk v0.0.100
...
require (
	...
	github.com/unstablebuild/blue v1.81.3
...
replace github.com/hajimehoshi/ebiten/v2 => github.com/unstablebuild/ebiten/v2 v2.7.5-ub.14
